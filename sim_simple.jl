...
# ╔═╡ 37af6f76-aa8c-4c7f-8705-e55101f22186
begin
	cool_theme = Theme(
...
# ╔═╡ 91e5f121-1224-42a9-978b-5b087d9e8d78
include_sims_in_viz = false
...
begin
	...
	sim_probs_survival = zeros(N)
	for i = 1:N
		sim_probs_survival[i] = sum(sim_nb_eliminated .< i) / nb_sims
	end
	sim_probs_survival
...
begin
	...
	barplot!(1:N, probs_survival, 
		color=ColorSchemes.Derain[2], label="theory")
	if include_sims_in_viz
...
begin
	...
	ax2 = Axis(
		...
		ylabel="expected # of survivors, 𝔼[θ]",
	...
	hlines!(ax2, N, color="gray", label="all survive", linestyle=:dash)

	barplot!(Ls, [Eθ(L_i, N) for L_i in Ls], linewidth=6, color=ColorSchemes.Derain[5])
